...
<section class="standard-form">
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-header bg-primary text-white d-flex align-items-center justify-content-between p-3 rounded-top-3">
            <h2 class="h5 mb-0 fw-semibold">Edit Standard: {{ $standard->standard_name }}</h2>
        ...
        <div class="card-body p-4">
            ...
            <form method="POST" action="{{ route('standards.update', $standard->id) }}" enctype="multipart/form-data">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="standard_name" id="standard_name" class="form-control rounded-3"
                               placeholder="e.g., ISO 9001" value="{{ old('standard_name', $standard->standard_name) }}" required>
                        @error('standard_name')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="standard_number" id="standard_number" class="form-control rounded-3"
                               placeholder="e.g., 9001" value="{{ old('standard_number', $standard->standard_number) }}" required>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <textarea name="standard" id="standard" class="form-control rounded-3" rows="4"
                                  placeholder="Brief description of the standard">{{ old('standard', $standard->standard) }}</textarea>
                        @error('standard')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" name="clause" id="clause" class="form-control rounded-3"
                               placeholder="e.g., Clause 7.1" value="{{ old('clause', $standard->clause) }}">
                        @error('clause')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="revision_version" id="revision_version" class="form-control rounded-3"
                               placeholder="e.g., v2.1" value="{{ old('revision_version', $standard->revision_version) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="date_created" id="date_created" class="form-control rounded-3"
                               value="{{ old('date_created', $standard->date_created) }}">
                        @error('date_created')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="date" name="date_of_issue" id="date_of_issue" class="form-control rounded-3"
                               value="{{ old('date_of_issue', $standard->date_of_issue) }}">
                        @error('date_of_issue')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="date" name="next_revision_date" id="next_revision_date" class="form-control rounded-3"
                               value="{{ old('next_revision_date', $standard->next_revision_date) }}">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="date" name="next_date_of_issue" id="next_date_of_issue" class="form-control rounded-3"
                               value="{{ old('next_date_of_issue', $standard->next_date_of_issue) }}">
                ...
                <p class="text-muted small">To replace a file, simply upload a new one. The old file will be deleted automatically.</p>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-primary rounded-3 px-4 fw-medium">
                        <i class="fas fa-check me-2"></i>Update Standard
                    </button>
                </div>
            </form>
        </div>
...
<style>
    ...
    /* --- This is the media query that was completed --- */
